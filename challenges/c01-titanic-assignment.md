...
- If yes, what might account for those differences?
  ...
  - The data set might be older than the Wikipedia article, it is
    possible that some of the people aboard were not accounted for when
    it was created.
...
- Is there anything *fishy* going on in your plot?
  - There is a warning that says 4 rows containing missing values/values
    outside the range were removed.
...
- If you saw something *fishy* in q4 above, use your new plot to explain
  the fishy-ness.
  - The plot from q4 did not distinguish between adults and children.
    Survival rates for children were significantly different from
    adults. The higher survival rate of children messed up the
    proportionality grouping, showing that all males and females of
    first and second class survived when in reality it was only all the
    children of those classes who survived.
