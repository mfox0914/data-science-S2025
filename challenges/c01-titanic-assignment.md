...
- If you saw something *fishy* in q4 above, use your new plot to explain
  ...
  - The plot from q4 did not distinguish between adults and children.
    ...
    adults. The q4 plot had the survival rates for children and adults
    overlapping. Since both bars were the same color, they were
    indistinguishable, causing it to look like the same amount of
    children and adults survived.
