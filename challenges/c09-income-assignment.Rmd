...
-   Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
    -   Suffolk county has the smallest confidence intervals, making it easier to distinguish between different household incomes. However, the confidence intervals are not negligible, so you cannot confidently give a single number for median household income.
...
-   What *overall* trend do you see between `SE` and population? Why might this trend exist?
    ...
    -   Larger populations allow for larger sample sizes in the survey, decreasing sampling variability. This allows for more precise estimates of the median income.
