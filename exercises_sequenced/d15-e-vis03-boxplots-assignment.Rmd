...
Minivans tend to be the most middle for displacement values. It was easier to see this with the boxplot as the boxes make it very easy to see the information I need. The other plot is difficult to read due to the thin, overlapping lines and many colors.
